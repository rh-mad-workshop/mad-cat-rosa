...
[NOTE]
====
Normally you would need to get a *token* from the https://console.redhat.com/openshift/token/rosa[Red Hat Console,window=_blank] and log into ROSA using that token.
...
----
+
See https://docs.openshift.com/rosa/rosa_planning/rosa-sts-required-aws-service-quotas.html[the documentation,window=_blank] for more details regarding quotas.
