...
Your pre-provisioned cluster is accessible at: {rosa_openshift_console_url}[ROSA Console URL,window=_blank]

To continue the lab now please follow this link to go to the next section: link:./lab_4_access_cluster.html[Create an Admin User].
====
