...
[TIP]
====
Click on `Congnito` then it will log in to Kiali automatically. In case you need to key in the username and password again, use the Cognito credential you created in the previous lab.
====
+
